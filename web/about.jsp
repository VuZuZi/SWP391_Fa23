...
<!--                                <ul class="list-group list-group-flush" id="list2">
    ...
    <script>
//        const commentInput = document.getElementById('commentButton');
...
//    // Thực hiện hành động "Post" ở đây
//    alert('Post: ' + commentInput.value);
//    // Sau khi "Post," bạn có thể đặt lại nút bằng cách gỡ bỏ lớp "active"
//    commentInput.value = '';
//    postButton.classList.remove('active');
//  }
//});
 ...
 function cmt(){
   const commentInput1 = document.getElementById('commentButton');
    ...
    // Thiết lập nội dung cho thẻ <div>
