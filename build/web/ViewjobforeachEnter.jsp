<%-- 
    Document   : ViewjobforeachEnter
    Created on : Nov 1, 2023, 1:29:31 AM
    Author     : ASUS
--%>
            ...
            <div class="site-wrap">
                ...
                <section class="site-section">
                    <div class="container">
                        ...
                        <div class="row mb-5">
                            <div class="col-lg-12">
                                <form action="UpdateJob" class="p-4 p-md-5 border rounded" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" id="name" value="${JobDetail.getTitle()}">
                                    </div>
                                    <div class="form-group">
                                        <label for="phone" class="text-capitalize">Location</label>
                                        <input type="text" name="location" class="form-control" id="phone" value="${JobDetail.getLocation()}" >
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-4">
                                            <label for="job-location">Type</label>
                                            <input type="text" name="type" class="form-control" id="phone" value="${JobDetail.getType()}" >
                                        </div>
                                        <div class="col-4">
                                            <label for="job-location">Skills</label>
                                            <input type="text" name="skill" class="form-control" id="phone" value="${JobDetail.getSkills()}" >
                                        </div>
                                        <div class="col-4">
                                            <label for="job-location">Salary</label>
                                            <input type="text" name="salary" class="form-control" id="phone" value="${JobDetail.getSalary()}" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="row mb-5 justify-content-end">
                                        <div class="col-lg-3 col-md-3">
                                            <button type="submit" class="btn btn-block btn-secondary btn-md text-white">Update Job</button>
                                        </div>
                                        <div class="col-lg-3 col-md-3">
                                            <a href="ViewPostedJob" htype="submit" class="btn btn-block btn-secondary btn-md text-white">Back To List</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
