<%-- Document : signup Created on : Oct 1, 2023, 3:20:27 PM Author : ASUS --%>
        ...
        <%@page contentType="text/html" pageEncoding="UTF-8" %>
            ...
            <body id="top">
                                ...
                                <div class="offset-3 col-lg-6 mb-5">
                                    ...
                                    <form action="SignUpServlet" method="POST" class="p-4 border rounded">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="email" class="form-control" id="username_input"
                                                name="email-input" placeholder="Username">
                                            <span class="message-form"></span>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label class="label" for="">Password</label>
                                            <input type="password" class="form-control" id="pass_input"
                                                name="pass-input" placeholder="Password">
                                            <span class="message-form"></span>
                                        </div>
                                        <div class="form-group mb-2">
                                            <label class="label" for="">Confirm password</label>
                                            <input type="password" class="form-control" id="confirmpass_input"
                                                name="confirm-input" placeholder="Confirm password">
                ...
                <script>
                    ...
                    // Utility function to display error or clear messages
                    function showMessage(message, isError = true) {
                        messageResponse.classList.remove("d-none");
                        messageResponse.innerHTML = message;
                        if (isError) {
                            messageResponse.classList.remove("success");
                        } else {
                            messageResponse.classList.add("success"); // You can define a success class in your CSS for styling
                        }
                    }
                    ...
                    passwordInput.addEventListener("input", function (e) {
                        ...
                        const isPasswordValidMessage = isPasswordValid(password);

                        if (isPasswordValidMessage === "Password is valid") {
                            clearMessage();
                        } else {
                            showMessage(isPasswordValidMessage);
                        }
                    });

                    // Event listener for the password confirmation
                    confirmPassInput.addEventListener("input", function (e) {
                        if (passwordInput.value !== confirmPassInput.value) {
                            showMessage(errorMessages.missConfirmPassword);
                        } else {
                            clearMessage();
                        }
                    });
                    ...
                    form.addEventListener("submit", function (e) {
                        ...
                        // Check the validity of each form field and password
                        const isUsernameValid = usernameInput.checkValidity() && isFieldNotEmpty(usernameInput);
                        const isRoleValid = roleInput.checkValidity() && isFieldNotEmpty(roleInput);
                        const isPasswordValidMessage = isPasswordValid(passwordInput.value);

                        if (isUsernameValid && isRoleValid && isPasswordValidMessage === "Password is valid") {
                            clearMessage();
                            form.submit();
                        } else {
                            showMessage(
                                isPasswordValidMessage === "Password is valid"
                                    ? errorMessages.missInput
