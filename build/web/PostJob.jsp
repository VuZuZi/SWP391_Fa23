            ...
            <form action="PostJobServlet" class="p-4 p-md-5 border rounded" method="post">
              ...
              <div class="form-group row">
                <div class="col-6">
                  ...
                  <input type="date" class="form-control" id="job-date-open">
                </div>
                <div class="col-6">
                  <label for="job-location">Date Close</label>
                  <input type="date" class="form-control" id="job-date-close">
                </div>
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="job-salary" placeholder="Salary">
              </div>
